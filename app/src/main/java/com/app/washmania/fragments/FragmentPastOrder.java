...
import com.app.washmania.adapter.MyOrderAdapterPast;
...
public class FragmentPastOrder extends Fragment {
    ...
    public void parsejson() {
        ...
        Call<Myorders> call = redditAPI.GetOrderListResponse(WMPreference.INSTANCE.get_userId(mContext), "Paid");
    ...
    private void inflateAdapter() {
        MyOrderAdapterPast ca = new MyOrderAdapterPast(productsMod.getOrderData(), mContext, FragmentPastOrder.this);
