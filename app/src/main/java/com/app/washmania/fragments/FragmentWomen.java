...
public class FragmentWomen extends Fragment implements ProductAdapter.IntCartCount{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragmnet_women, container, false);
        ...
        //Utility.INSTANCE.showToastShort(mContext, "IDS: "+strtext);
        initViews();
