...
import com.app.washmania.adapter.MyOrderAdapterActive;
...
public class FragmentActiveOrder extends Fragment {
    ...
    public void parsejson() {
        ...
        Call<Myorders> call = redditAPI.GetOrderListResponse(WMPreference.INSTANCE.get_userId(mContext), "Pending");
    ...
    private void inflateAdapter() {
        MyOrderAdapterActive ca = new MyOrderAdapterActive(productsMod.getOrderData(), mContext,FragmentActiveOrder.this);
