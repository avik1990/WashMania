...
import com.app.washmania.model.Privacymodel
...
class PrivacyActivity : BaseActivity(), View.OnClickListener {
    ...
    private fun parsejson() {
        ...
        val call = redditAPI.GetPrivacyData()
        call.enqueue(object : Callback<Privacymodel> {

            override fun onResponse(call: Call<Privacymodel>, response: retrofit2.Response<Privacymodel>) {
            ...
            override fun onFailure(call: Call<Privacymodel>, t: Throwable) {
                pDialog.dismiss()
            }
        })
    }
