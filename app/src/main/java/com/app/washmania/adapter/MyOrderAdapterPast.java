...
public class MyOrderAdapterPast extends RecyclerView.Adapter<MyOrderAdapterPast.MyViewHolder> {
    ...
    FragmentPastOrder fragmentPastOrder;

    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tvOrderIds,tvOrderId, tvPrice, tvBookedOn, tvPaymentMode, tvPaymentStatus, tvPickuppBoy, tvDeliveryStatus;
        Button btn_cancel;
        TextView tvCartId;
        LinearLayout llInfo;
    ...
    public MyOrderAdapterPast(List<Myorders.OrderDatum> moviesList, Context mContext, FragmentPastOrder fragmentPastOrder) {
        ...
        this.fragmentPastOrder = fragmentPastOrder;
    }
