...
public class OrderDetailsAdapterBCK extends RecyclerView.Adapter<OrderDetailsAdapterBCK.MyViewHolder> {
    private List<OrderDetailsModel.CartDatum> moviesList;
    private List<OrderDetailsModel.CartDatum> moviesList1;
    private List<OrderDetailsModel.CartDatum> mArrayList;
    Context mContext;
    private int amount = 0;
    OrderDetailsModel.CartDatum movie;
    ...
    public OrderDetailsAdapterBCK(List<OrderDetailsModel.CartDatum> moviesList, Context mContext) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tv_price.setText("\u20B9" + " " + String.valueOf(movie.getDressPrice()));
